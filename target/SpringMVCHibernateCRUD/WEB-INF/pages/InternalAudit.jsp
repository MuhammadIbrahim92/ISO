...
<div class="card mb-4 wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
  ...
  <form role="form" action="" method="post">
      ...
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input maxlength="100" type="text" required="required" class="form-control" placeholder="Process Name" />
          </div>
          <div class="form-group">
            <label class="control-label">Auditee</label>
        <input maxlength="100" type="text" required="required" class="form-control" placeholder="Auditee" />
          </div>
    ...
    <textarea required="required" class="form-control" placeholder="Excutive Summary..." ></textarea>
    </div>
  </div>
  <div class="card">
    <div class="card-header text-white bg-primary">
    ...
    <textarea required="required" class="form-control" placeholder="Audit Findings..." ></textarea>
    </div>
  </div>
  <div class="card">
    <div class="card-header text-white bg-primary">
    ...
    <textarea required="required" class="form-control" placeholder="Reviewed Records..." ></textarea>
    </div>
  </div>
