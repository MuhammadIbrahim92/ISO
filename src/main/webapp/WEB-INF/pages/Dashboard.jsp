...
<div class="card mb-4 wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
 ...
 <script type="text/javascript">
    ...
    var dynamicColors = function() {
        ...
        for (var i in ${auditsperStatuslabel}) {
           coloR2.push(dynamicColors());
        }
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels:${auditsperStatuslabel} ,
                datasets: [{
                    label: '# of Audits',
                    data: ${auditsperStatuscount},
        ...
        for (var i in ${pendingperDeptLabel}) {
           coloR.push(dynamicColors());
        }
        var myPieChart = new Chart(ctxP, {
            type: 'pie',
            data: {
                labels:${pendingperDeptLabel},
                datasets: [{
                    data: ${PendingDeptcounts},
        ...
        for (var i in ${CompletedDeptLabel}) {
           coloR.push(dynamicColors());
        }
        var myPieChart2 = new Chart(ctxP, {
            type: 'pie',
            data: {
                labels:${CompletedDeptLabel},
                datasets: [{
                    data: ${CompletedDeptcounts},
                    backgroundColor: coloR,
                    hoverBackgroundColor: coloR
                }]
            },
