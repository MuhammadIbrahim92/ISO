...
<div class="card mb-4 wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                ...
                <div class="card-body d-sm-flex justify-content-between">
                      ...
                      <h4 class="mb-2 mb-sm-0 pt-1">
                         <span> <i class="fa fa-user"></i> &nbsp <fmt:message key="label.UserDetail" /></span>
  ...
  <form:form action="saveUser" method="post" modelAttribute="user" id="saveUser" autocomplete="off">
    <form:hidden path="uSER_ID"/>
     <form:hidden path="uSER_ACTIVE"/>
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-6">
            ...
            <label class="control-label"><fmt:message key="label.userName" />  </label>
             <form:input  class="form-control " path="uSER_NAME" readonly="${user.uSER_ID != 0}"/> 
            </div>
			<div class="form-group">
 ...
 <div class="form-group">
            <label class="control-label"><fmt:message key="label.Tel" />  </label>            
             <form:input  type="text"  class="form-control " path="uSER_TEL" /> 
            </div>
			<div class="form-group">
            <label class="control-label"><fmt:message key="label.Pass" />  </label>            
             <form:input  type="password"  class="form-control " path="uSER_PASS" /> 
            </div>
                 <div class="form-group">
            <label class="control-label"><fmt:message key="label.UserType" />  </label>            
             <form:select  type="password"  class="form-control " path="uSER_TYPE" > 
                <option value="Normal"<c:if test="${user.uSER_TYPE == 'Normal'}"> selected </c:if>>Normal</option>
               <option value="Admin"<c:if test="${user.uSER_TYPE == 'Admin'}"> selected </c:if>>Admin</option>
             </form:select>
            </div>    
